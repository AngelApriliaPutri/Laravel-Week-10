...
Route::get('/contact/list', [ContactController::class, 'ContactList'])->name('contact_list');
Route::delete('/contact/{id}', [ContactController::class, 'deleteContact'])->name('delete_contact');
